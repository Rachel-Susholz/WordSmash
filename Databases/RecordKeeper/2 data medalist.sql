...
union select 1900, 'Summer', 'Paris, France', 'Athletics', '2500 Metres Steeplechase', 'Silver', 'Sidney', 'Robinson', 'Great Britain', 1876
...
union select 1908, 'Summer', 'London, United Kingdom', 'Athletics', '10 Miles Walk', 'Gold', 'George', 'Larner', 'Great Britain', 1875
union select 1908, 'Summer', 'London, United Kingdom', 'Athletics', '10 Miles Walk', 'Silver', 'Ernest', 'Webb', 'Great Britain', 1874
union select 1908, 'Summer', 'London, United Kingdom', 'Athletics', '10 Miles Walk', 'Bronze', 'Edward', 'Spencer', 'Great Britain', 1881
...
union select 1908, 'Summer', 'London, United Kingdom', 'Boxing', 'Heavyweight', 'Gold', 'Albert', 'Oldman', 'Great Britain', 1883
union select 1908, 'Summer', 'London, United Kingdom', 'Boxing', 'Heavyweight', 'Silver', 'Sidney', 'Evans', 'Great Britain', 1881
union select 1908, 'Summer', 'London, United Kingdom', 'Boxing', 'Heavyweight', 'Bronze', 'Frank', 'Parks', 'Great Britain', 1875
union select 1908, 'Summer', 'London, United Kingdom', 'Tennis', 'Women''s Indoor Singles', 'Gold', 'Gwendoline', 'Eastlake-Smith', 'Great Britain', 1883
union select 1908, 'Summer', 'London, United Kingdom', 'Tennis', 'Women''s Indoor Singles', 'Silver', 'Alice', 'Greene', 'Great Britain', 1879
...
union select 1912, 'Summer', 'Stockholm, Sweden', 'Cycling', 'Individual Time Trial', 'Silver', 'Freddie', 'Grubb', 'Great Britain', 1887
...
union select 1924, 'Winter', 'Chamonix, France', 'Figure Skating', 'Ladies'' Singles', 'Bronze', 'Ethel', 'Muckelt', 'Great Britain', 1885
...
union select 1928, 'Winter', 'St. Moritz, Switzerland', 'Skeleton', 'Men''s Individual', 'Bronze', 'David', 'Carnegie', 'Great Britain', 1901
...
union select 1932, 'Summer', 'Los Angeles, United States', 'Athletics', 'Women''s 100 M', 'Gold', 'Stanisława', 'Walasiewicz', 'Poland', 1911
union select 1932, 'Summer', 'Los Angeles, United States', 'Athletics', 'Women''s 100 M', 'Silver', 'Hilda', 'Strike', 'Canada', 1910
union select 1932, 'Summer', 'Los Angeles, United States', 'Athletics', 'Women''s 100 M', 'Bronze', 'Wilhelmina', 'von Bremen', 'United States', 1909
union select 1932, 'Summer', 'Los Angeles, United States', 'Boxing', 'Featherweight', 'Gold', 'Carmelo', 'Robledo', 'Argentina', 1912
union select 1932, 'Summer', 'Los Angeles, United States', 'Boxing', 'Featherweight', 'Silver', 'Josef', 'Schleinkofer', 'Germany', 1910
union select 1932, 'Summer', 'Los Angeles, United States', 'Boxing', 'Featherweight', 'Bronze', 'Allan', 'Carlsson', 'Sweden', 1910
union select 1932, 'Summer', 'Los Angeles, United States', 'Cycling', 'Individual Time Trial', 'Gold', 'Attilio', 'Pavesi', 'Italy', 1910
union select 1932, 'Summer', 'Los Angeles, United States', 'Cycling', 'Individual Time Trial', 'Silver', 'Guglielmo', 'Segato', 'Italy', 1906
union select 1932, 'Summer', 'Los Angeles, United States', 'Cycling', 'Individual Time Trial', 'Bronze', 'Bernhard', 'Britz', 'Sweden', 1906
union select 1932, 'Summer', 'Los Angeles, United States', 'Diving', '10 Metre Platform', 'Gold', 'Dorothy', 'Poynton-Hill', 'United States', 1915
union select 1932, 'Summer', 'Los Angeles, United States', 'Diving', '10 Metre Platform', 'Silver', 'Georgia', 'Coleman', 'United States', 1912
union select 1932, 'Summer', 'Los Angeles, United States', 'Diving', '10 Metre Platform', 'Bronze', 'Marion', 'Roper', 'United States', 1910
union select 1932, 'Winter', 'Lake Placid, United States', 'Ski Jumping', 'Men''s Individual', 'Gold', 'Birger', 'Ruud', 'Norway', 1911
union select 1932, 'Winter', 'Lake Placid, United States', 'Ski Jumping', 'Men''s Individual', 'Silver', 'Hans', 'Beck', 'Norway', 1911
union select 1932, 'Winter', 'Lake Placid, United States', 'Ski Jumping', 'Men''s Individual', 'Bronze', 'Kaare', 'Walberg', 'Norway', 1912
union select 1932, 'Winter', 'Lake Placid, United States', 'Nordic Combined', 'Men''s Individual', 'Gold', 'Johan', 'Grøttumsbråten', 'Norway', 1899
union select 1932, 'Winter', 'Lake Placid, United States', 'Nordic Combined', 'Men''s Individual', 'Silver', 'Ole', 'Stenen', 'Norway', 1903
union select 1932, 'Winter', 'Lake Placid, United States', 'Nordic Combined', 'Men''s Individual', 'Bronze', 'Hans', 'Vinjarengen', 'Norway', 1905
union select 1932, 'Winter', 'Lake Placid, United States', 'Figure Skating', 'Men''s Singles', 'Gold', 'Karl', 'Schäfer', 'Austria', 1909
union select 1932, 'Winter', 'Lake Placid, United States', 'Figure Skating', 'Men''s Singles', 'Silver', 'Gillis', 'Grafström', 'Sweden', 1893
union select 1932, 'Winter', 'Lake Placid, United States', 'Figure Skating', 'Men''s Singles', 'Bronze', 'Montgomery', 'Wilson', 'Canada', 1909
...
union select 1936, 'Winter', 'Garmisch-Partenkirchen, Germany', 'Figure Skating', 'Ladies'' Singles', 'Silver', 'Cecilia', 'Colledge', 'Great Britain', 1920
...
union select 1948, 'Summer', 'London, United Kingdom', 'Athletics', 'Women''s 80 M Hurdles', 'Silver', 'Maureen', 'Gardner', 'Great Britain', 1928
...
union select 1960, 'Winter', 'Squaw Valley, United States', 'Alpine Skiing', 'Men''s Downhill', 'Gold', 'Jean', 'Vuarnet', 'France', 1933
union select 1960, 'Winter', 'Squaw Valley, United States', 'Alpine Skiing', 'Men''s Downhill', 'Silver', 'Hans-Peter', 'Lanig', 'Germany', 1935
union select 1960, 'Winter', 'Squaw Valley, United States', 'Alpine Skiing', 'Men''s Downhill', 'Bronze', 'Guy', 'Périllat', 'France', 1940
union select 1960, 'Winter', 'Squaw Valley, United States', 'Biathlon', 'Men''s 20 Km', 'Gold', 'Klas', 'Lestander', 'Sweden', 1931
union select 1960, 'Winter', 'Squaw Valley, United States', 'Biathlon', 'Men''s 20 Km', 'Silver', 'Antti', 'Tyrväinen', 'Finland', 1933
union select 1960, 'Winter', 'Squaw Valley, United States', 'Biathlon', 'Men''s 20 Km', 'Bronze', 'Aleksandr', 'Privalov', 'Soviet Union', 1933
union select 1960, 'Winter', 'Squaw Valley, United States', 'Cross-country Skiing', 'Women''s 10 Km', 'Gold', 'Maria', 'Gusakova', 'Soviet Union', 1931
union select 1960, 'Winter', 'Squaw Valley, United States', 'Cross-country Skiing', 'Women''s 10 Km', 'Silver', 'Lyubov', 'Kozyreva', 'Soviet Union', 1929
union select 1960, 'Winter', 'Squaw Valley, United States', 'Cross-country Skiing', 'Women''s 10 Km', 'Bronze', 'Radya', 'Yeroshina', 'Soviet Union', 1930
union select 1960, 'Winter', 'Squaw Valley, United States', 'Ski Jumping', 'Men''s Individual', 'Gold', 'Helmut', 'Recknagel', 'Germany',1937 
union select 1960, 'Winter', 'Squaw Valley, United States', 'Ski Jumping', 'Men''s Individual', 'Silver', 'Niilo', 'Halonen', 'Finland', 1940
union select 1960, 'Winter', 'Squaw Valley, United States', 'Ski Jumping', 'Men''s Individual', 'Bronze', 'Otto', 'Leodolter', 'Austria', 1936
union select 1960, 'Winter', 'Squaw Valley, United States', 'Speed Skating', 'Men''s 500 Metres', 'Gold', 'Yevgeny', 'Grishin', 'Soviet Union',1931
union select 1960, 'Winter', 'Squaw Valley, United States', 'Speed Skating', 'Men''s 500 Metres', 'Silver', 'Bill', 'Disney', 'United States', 1932
union select 1960, 'Winter', 'Squaw Valley, United States', 'Speed Skating', 'Men''s 500 Metres', 'Bronze', 'Rafayel', 'Grach', 'Soviet Union', 1932
...
union select 1976, 'Summer', 'Montreal, Canada', 'Swimming', '100 M Freestyle', 'Gold', 'Kornelia', 'Ender', 'East Germany', 1958
union select 1976, 'Summer', 'Montreal, Canada', 'Swimming', '100 M Freestyle', 'Silver', 'Petra', 'Priemer', 'East Germany', 1961
union select 1976, 'Summer', 'Montreal, Canada', 'Swimming', '100 M Freestyle', 'Bronze', 'Enith', 'Brigitha', 'Netherlands', 1955
union select 1976, 'Summer', 'Montreal, Canada', 'Archery', 'Mens''', 'Gold', 'Darrell', 'Pace', 'United States', 1956
union select 1976, 'Summer', 'Montreal, Canada', 'Archery', 'Mens''', 'Silver', 'Hiroshi', 'Michinaga', 'Japan', 1956
union select 1976, 'Summer', 'Montreal, Canada', 'Archery', 'Mens''', 'Bronze', 'Giancarlo', 'Ferrari', 'Italy', 1942
union select 1976, 'Summer', 'Montreal, Canada', 'Athletics', '100 M', 'Gold', 'Hasely', 'Crawford', 'Trinidad and Tobago', 1950
union select 1976, 'Summer', 'Montreal, Canada', 'Athletics', '100 M', 'Silver', 'Don', 'Quarrie', 'Jamaica', 1951
union select 1976, 'Summer', 'Montreal, Canada', 'Athletics', '100 M', 'Bronze', 'Valeriy', 'Borzov', 'Soviet Union', 1949
union select 1976, 'Summer', 'Montreal, Canada', 'Gymnastics', 'Uneven Bars', 'Gold', 'Nadia', 'Comăneci', 'Romania', 1961
union select 1976, 'Summer', 'Montreal, Canada', 'Gymnastics', 'Uneven Bars', 'Silver', 'Teodora', 'Ungureanu', 'Romania', 1960
union select 1976, 'Summer', 'Montreal, Canada', 'Gymnastics', 'Uneven Bars', 'Bronze', 'Márta', 'Egervári', 'Hungary', 1956
union select 1976, 'Winter', 'Innsbruck, Austria', 'Figure Skating', 'Men''s Singles', 'Gold', 'John', 'Curry', 'Great Britain', 1949
...
union select 1980, 'Winter', 'Lake Placid, United States', 'Speed Skating', 'Men''s 5,000 Metres', 'Gold', 'Eric', 'Heiden', 'United States', 1958
union select 1980, 'Winter', 'Lake Placid, United States', 'Speed Skating', 'Men''s 5,000 Metres', 'Silver', 'Kay', 'Stenshjemmet', 'Norway', 1953
union select 1980, 'Winter', 'Lake Placid, United States', 'Speed Skating', 'Men''s 5,000 Metres', 'Bronze', 'Tom Erik', 'Oxholm', 'Norway', 1959
union select 1980, 'Winter', 'Lake Placid, United States', 'Speed Skating', 'Women''s 1,500 Metres', 'Gold', 'Annie', 'Borckink', 'Netherlands', 1951
union select 1980, 'Winter', 'Lake Placid, United States', 'Speed Skating', 'Women''s 1,500 Metres', 'Silver', 'Ria', 'Visser', 'Netherlands', 1961
union select 1980, 'Winter', 'Lake Placid, United States', 'Speed Skating', 'Women''s 1,500 Metres', 'Bronze', 'Sabine', 'Becker', 'East Germany', 1959
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Men''s Downhill', 'Gold', 'Leonhard', 'Stock', 'Austria', 1958
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Men''s Downhill', 'Silver', 'Peter', 'Wirnsberger', 'Austria', 1958
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Men''s Downhill', 'Bronze', 'Steve', 'Podborski', 'Canada', 1957
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Women''s Downhill', 'Gold', 'Annemarie', 'Moser-Pröll', 'Austria', 1953
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Women''s Downhill', 'Silver', 'Hanni', 'Wenzel', 'Liechtenstein', 1956
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Women''s Downhill', 'Bronze', 'Marie-Theres', 'Nadig', 'Switzerland', 1954
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Men''s Slalom', 'Gold', 'Ingemar', 'Stenmark', 'Sweden', 1956
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Men''s Slalom', 'Silver', 'Phil', 'Mahre', 'United States', 1957
union select 1980, 'Winter', 'Lake Placid, United States', 'Alpine Skiing', 'Men''s Slalom', 'Bronze', 'Jacques', 'Lüthy', 'Switzerland', 1959
...
union select 2000, 'Summer', 'Sydney, Australia', 'Athletics', '200 Metres', 'Silver', 'Darren', 'Campbell', 'Great Britain', 1973
...
union select 2002, 'Winter', 'Salt Lake City, United States', 'Alpine Skiing', 'Women''s Super-G', 'Gold', 'Daniela', 'Ceccarelli', 'Italy', 1975
union select 2002, 'Winter', 'Salt Lake City, United States', 'Alpine Skiing', 'Women''s Super-G', 'Silver', 'Janica', 'Kostelić', 'Croatia', 1982
union select 2002, 'Winter', 'Salt Lake City, United States', 'Alpine Skiing', 'Women''s Super-G', 'Bronze', 'Karen', 'Putzer', 'Italy', 1978
union select 2002, 'Winter', 'Salt Lake City, United States', 'Figure Skating', 'Women''s Singles', 'Gold', 'Sarah', 'Hughes', 'United States', 1985
union select 2002, 'Winter', 'Salt Lake City, United States', 'Figure Skating', 'Women''s Singles', 'Silver', 'Irina', 'Slutskaya', 'Russia', 1979
union select 2002, 'Winter', 'Salt Lake City, United States', 'Figure Skating', 'Women''s Singles', 'Bronze', 'Michelle', 'Kwan', 'United States', 1980
union select 2002, 'Winter', 'Salt Lake City, United States', 'Freestyle Skiing', 'Men''s Moguls', 'Gold', 'Janne', 'Lahtela', 'Finland', 1974
union select 2002, 'Winter', 'Salt Lake City, United States', 'Freestyle Skiing', 'Men''s Moguls', 'Silver', 'Travis', 'Mayer', 'United States', 1982
union select 2002, 'Winter', 'Salt Lake City, United States', 'Freestyle Skiing', 'Women''s Aerials', 'Gold', 'Alisa', 'Camplin', 'Australia', 1974
union select 2002, 'Winter', 'Salt Lake City, United States', 'Freestyle Skiing', 'Women''s Aerials', 'Silver', 'Veronica', 'Brenner', 'Canada', 1974
union select 2002, 'Winter', 'Salt Lake City, United States', 'Freestyle Skiing', 'Women''s Aerials', 'Bronze', 'Deidra', 'Dionne', 'Canada', 1982
...
union select 2004, 'Summer', 'Athens, Greece', 'Archery', 'Women''s Individual', 'Bronze', 'Alison', 'Williamson', 'Great Britain', 1971
